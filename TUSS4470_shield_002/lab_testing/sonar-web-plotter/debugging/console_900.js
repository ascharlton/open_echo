// sonar_console.js console script for viewing 900 samples 
...
const THRESHOLD = 230;                  // Minimum value a point must have to be considered a peak
    ...
    try {
        ...
        port.on('data', data => {
            ...
            while ((packet = extractAndProcessPacket())) {
                ...
                console.log("\n" + "=".repeat(100));
                console.log(`Time: ${timeString} | Depth: ${depthCm} cm | Temp: ${temperature} °C | Vdrv: ${driveVoltage} V`);
