...
class WaterfallApp(QMainWindow):
    def __init__(self):
        ...
        self.imageitem.setTransform(pg.QtGui.QTransform().scale(-1, 1))  # ← flip horizontally
    ...
    def waterfall_plot_callback(self, spectrogram, depth_index, temperature, drive_voltage):
        ...
        alpha = 5  # smoothing factor, tweak 0.1–0.5 as needed
        ...
        in_range_mask = (self.ema_data[-1, :] >= 20) & (self.ema_data[-1, :] <= 150)
        ...
        self.imageitem.setImage(np.fliplr(self.data.T), autoLevels=False)
